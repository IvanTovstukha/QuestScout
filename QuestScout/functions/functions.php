...
$con = mysqli_connect("localhost", "root", "", "questscoutdb");
    ...
    if (!isset($_GET['cat'])) {
        if (!isset($_GET['type'])) {
            ...
            while ($row_pack = mysqli_fetch_array($run_pack)) {
                ...
                echo "
				<div id='single_package' style='padding: 10px; margin-bottom: 20px;'>
				    <h3 style='font-family: Cambria; margin-bottom: 2px;'>$pack_title</h3>
				    <img src='admin_area/package_images/$pack_image' width='180' height='180' style='margin-bottom: 10px;'>
