...
<body bgcolor="skyblue">
    <form action="" method="post" enctype="multipart/form-data">
        <table align="center" width="795" border="2px" bgcolor="ABB3C8">
            <tr align="center">
                <td colspan="7">
                    <h2 style="font-family: Cambria; margin-top: 20px; margin-bottom: 15px;">Edit & Update Quest</h2>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right"><b>Quest Category:</b></td>
                <td>
            ...
            <tr>
                <td align="right"><b>Quest Type:</b></td>
                <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <img src="package_images/<?php echo $pack_image; ?>" width="50" height="50">
                </td>
            </tr>
            <tr>
            ...
            <tr align="center">
                <td colspan="7">
                    <input style="margin-top: 10px; margin-bottom: 15px;" type="submit" name="update_package" value="Update Quest">
                </td>
            </tr>
        </table>
    </form>
...
if (isset($_POST['update_package'])) {
    ...
    if ($run_pack) {
        echo "<script>alert('QUEST has been UPDATED successfully!')</script>";
