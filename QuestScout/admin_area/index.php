    ...
    <body>
        <div class="main_wrapper">
            ...
            <div id="right">
                ...
                <ul>
                    <li><a href="index.php?insert_package">Insert New Quest</a></li>
                    <li><a href="index.php?view_packages">View All Quests</a></li>
                    <li><a href="index.php?insert_cat">Insert New Difficulty</a></li>
                    <li><a href="index.php?view_cats">View All Difficulty</a></li>
                    <li><a href="index.php?insert_type">Insert New Genre</a></li>
                    <li><a href="index.php?view_types">View All Genres</a></li>
