...
if (!isset($_SESSION['user_email'])) {
    ...
    <body>
        <table width="795" height="200" align="center" bgcolor="#EAD2AC">
            <tr align="center">
                <td colspan="6"><h2 style="font-family: Cambria; margin-top: 10px; margin-bottom: 5px;">View All Genres
                                                                                                        Here</h2></td>
            </tr>
            <tr align="center" bgcolor="#5FCEE8">
                <th id="thfix">genre ID</th>
                <th id="thfix">genre Title</th>
                <th id="thfix">Edit</th>
