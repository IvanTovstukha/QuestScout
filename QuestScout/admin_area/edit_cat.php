...
if (!isset($_SESSION['user_email'])) {
    ...
    <body>
        <form action="" method="post" style="padding: 80px;">
            <table align="center">
                <tr>
                    <td align="left"><b>Update Difficulty:</b></td>
                ...
                <tr>
                    <td></td>
                    <td align="right"><input id="btn" type="submit" name="update_cat" value="Update Difficulty"></td>
                </tr>
            </table>
        </form>
        ...
        if (isset($_POST['update_cat'])) {
            ...
            if ($run_cat) {
                echo "<script>alert('DIFFICULTY has been UPDATED successfully!')</script>";
